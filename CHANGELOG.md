...
- Add bcFips dependencies as server dependencies for single distribution that is FIPS capable ([#20400](https://github.com/opensearch-project/OpenSearch/pull/20400))
